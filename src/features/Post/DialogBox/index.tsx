...
export default function DialogBox({title, description, button1, button2, opened}: data): ReactElement {
  function close() {
          ...
          <div className="flex min-h-full items-center justify-center p-4">
            <DialogPanel className="w-96 rounded-lg bg-white backdrop-blur-2xl duration-300 ease-out data-[closed]:transform-[scale(95%)] data-[closed]:opacity-0">
              ...
              <div className="flex gap-2 justify-end p-3">
                <Button size="large" variant="secondary" onClick={close}>
                  {button1}
                </Button>
                <Button size="large" variant="danger" onClick={close}>
                  {button2}
                </Button>
              </div>
            </DialogPanel>
